                    ...
                    @if(!is_null($product))
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" step="any"
                                   id="product_price" name="product_price" placeholder="Product Price" required
                                   value="{{ !is_null($product)? $product->price : 0 }} ">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="product_discount">Product Discount</label>
                            <input type="number" class="form-control" step="any"
                                   id="product_discount" name="product_discount" placeholder="Product Discount" required
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="number" class="form-control" step="any"
                                   id="product_total" name="product_total" placeholder="Product Total" required
    ...
    $(document).ready(function () {
       ...
       $(document).on( 'click','.add-option-button',function (e) {
           ...
           if( !optionNameList.includes($optionName.val()))
           {
              ...
              optionNamesRow ='<td><input type="hidden" name="options[]" value="'+ $optionValue.val()+'"></td>'
           }
       ...
       function resetFileUpload(fileUploadID, imageID ){
           $('#'+imageID).attr('src','');
       }
           ...
           $(this).append(imagetag);
            $('#'+fileUploadID).on('change',function (e) {
                ...
                $removeThisImage.on('click',function (e) {
                    e.preventDefault();
                    resetFileUpload('#'+fileUploadID,'i'+fileUploadID);
                })
